...
> = {
  addUser?: Resolver<
    ...
    >
  >;
  addUserAddress?: Resolver<
    Maybe<ResolversTypes["Address"]>,
    ParentType,
    ContextType,
    RequireFields<MutationAddUserAddressArgs, "address" | "id">
  >;
  addProduct?: Resolver<
    Maybe<ResolversTypes["Product"]>,
    ParentType,
    ContextType,
    RequireFields<MutationAddProductArgs, "description" | "name" | "range">
  >;
...
export type UserInfosResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UserInfos"] = ResolversParentTypes["UserInfos"]
> = {
  token?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  user?: Resolver<
    Maybe<ResolversTypes["UserMinimal"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type UserMinimalResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UserMinimal"] = ResolversParentTypes["UserMinimal"]
> = {
  email?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  firstname?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
